...
public record ApplicationConfig(
    ...
    public record Kafka(boolean enabled, String updatesTopic, String bootstrapServers, String groupId,
                        String dlqTopicSuffix, int dlqTopicPartitions, int dlqReplicas) {
    }
}
